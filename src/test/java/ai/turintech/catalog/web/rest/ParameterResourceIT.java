...
class ParameterResourceIT {
    ...
    private static final Boolean DEFAULT_ENBLED = false;
    private static final Boolean UPDATED_ENBLED = true;
    ...
    void createParameter() throws Exception {
        ...
        assertThat(testParameter.getEnbled()).isEqualTo(DEFAULT_ENBLED);
    ...
    @Test
    void checkEnbledIsRequired() throws Exception {
        int databaseSizeBeforeTest = parameterRepository.findAll().collectList().block().size();
        // set the field null
        parameter.setEnbled(null);
    ...
    void getAllParameters() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].enbled")
            .value(hasItem(DEFAULT_ENBLED.booleanValue()))
            .jsonPath("$.[*].fixedValue")
    ...
    void getParameter() {
        ...
        webTestClient
            ...
            .jsonPath("$.enbled")
            .value(is(DEFAULT_ENBLED.booleanValue()))
            .jsonPath("$.fixedValue")
    ...
    void putExistingParameter() throws Exception {
        ...
        assertThat(testParameter.getEnbled()).isEqualTo(UPDATED_ENBLED);
