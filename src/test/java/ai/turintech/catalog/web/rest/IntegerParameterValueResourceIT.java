...
class IntegerParameterValueResourceIT {
    ...
    private static final Integer DEFAULT_RIGHT = 1;
    private static final Integer UPDATED_RIGHT = 2;
    ...
    public static IntegerParameterValue createEntity(EntityManager em) {
        IntegerParameterValue integerParameterValue = new IntegerParameterValue().left(DEFAULT_LEFT).right(DEFAULT_RIGHT);
    ...
    public static IntegerParameterValue createUpdatedEntity(EntityManager em) {
        IntegerParameterValue integerParameterValue = new IntegerParameterValue().left(UPDATED_LEFT).right(UPDATED_RIGHT);
        return integerParameterValue;
    }
    ...
    void createIntegerParameterValue() throws Exception {
        ...
        assertThat(testIntegerParameterValue.getLeft()).isEqualTo(DEFAULT_LEFT);
        assertThat(testIntegerParameterValue.getRight()).isEqualTo(DEFAULT_RIGHT);
    }
    ...
    void checkLeftIsRequired() throws Exception {
        ...
        // set the field null
        integerParameterValue.setLeft(null);
    ...
    void checkRightIsRequired() throws Exception {
        int databaseSizeBeforeTest = integerParameterValueRepository.findAll().collectList().block().size();
        // set the field null
        integerParameterValue.setRight(null);
    ...
    void getAllIntegerParameterValues() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].left")
            .value(hasItem(DEFAULT_LEFT))
            .jsonPath("$.[*].right")
            .value(hasItem(DEFAULT_RIGHT));
    }
    ...
    void getIntegerParameterValue() {
        ...
        webTestClient
            ...
            .jsonPath("$.left")
            .value(is(DEFAULT_LEFT))
            .jsonPath("$.right")
            .value(is(DEFAULT_RIGHT));
    }
    ...
    void putExistingIntegerParameterValue() throws Exception {
        ...
        IntegerParameterValue updatedIntegerParameterValue = integerParameterValueRepository
            ...
            .block();
        updatedIntegerParameterValue.left(UPDATED_LEFT).right(UPDATED_RIGHT);
        ...
        IntegerParameterValue testIntegerParameterValue = integerParameterValueList.get(integerParameterValueList.size() - 1);
        assertThat(testIntegerParameterValue.getLeft()).isEqualTo(UPDATED_LEFT);
        assertThat(testIntegerParameterValue.getRight()).isEqualTo(UPDATED_RIGHT);
    }
    ...
    void fullUpdateIntegerParameterValueWithPatch() throws Exception {
        ...
        partialUpdatedIntegerParameterValue.left(UPDATED_LEFT).right(UPDATED_RIGHT);
