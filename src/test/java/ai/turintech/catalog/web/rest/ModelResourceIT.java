...
class ModelResourceIT {
    ...
    private static final Boolean DEFAULT_DECISTION_TREE = false;
    private static final Boolean UPDATED_DECISTION_TREE = true;
    ...
    void getAllModels() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].decistionTree")
            .value(hasItem(DEFAULT_DECISTION_TREE.booleanValue()));
    }
    ...
    void getModel() {
        ...
        webTestClient
            ...
            .jsonPath("$.decistionTree")
            .value(is(DEFAULT_DECISTION_TREE.booleanValue()));
    }
