...
class FloatParameterRangeResourceIT {
    ...
    void createFloatParameterRange() throws Exception {
        ...
        assertThat(testFloatParameterRange.getLeft()).isEqualTo(DEFAULT_LEFT);
        assertThat(testFloatParameterRange.getRight()).isEqualTo(DEFAULT_RIGHT);
    }
    ...
    void checkLeftIsRequired() throws Exception {
        int databaseSizeBeforeTest = floatParameterRangeRepository.findAll().collectList().block().size();
        // set the field null
        floatParameterRange.setLeft(null);
    ...
    void checkRightIsRequired() throws Exception {
        int databaseSizeBeforeTest = floatParameterRangeRepository.findAll().collectList().block().size();
        // set the field null
        floatParameterRange.setRight(null);
    ...
    void putExistingFloatParameterRange() throws Exception {
        ...
        assertThat(testFloatParameterRange.getLeft()).isEqualTo(UPDATED_LEFT);
        assertThat(testFloatParameterRange.getRight()).isEqualTo(UPDATED_RIGHT);
    }
    ...
    void partialUpdateFloatParameterRangeWithPatch() throws Exception {
        ...
        partialUpdatedFloatParameterRange.left(UPDATED_LEFT);
